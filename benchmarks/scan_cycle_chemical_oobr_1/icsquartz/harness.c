...
struct Code {
    ...
    int8_t* field3;               // Corresponds to i8
    int8_t* iter;
    double array1[2];            // Corresponds to [2 x double]
    double array2[2];            // Corresponds to [2 x double]
    double value1;               // Corresponds to double
    double value2;               // Corresponds to double
    double value3;               // Corresponds to double
    double array3[21];           // Corresponds to [21 x double]
    double array4[21];           // Corresponds to [21 x double]
    int16_t field4;              // Corresponds to i16
    int32_t field5;              // Corresponds to i32
};
